	...
	<nav>
		...
		<div class="row">
			...
			<div class="col s4">
				...
				<div class="row">
					<div id="D1" class="col s12">
						<form method="post">
							<div class="row">
								<div class="input-field col s4">
									<input placeholder="Abscise X" id="X" name="X" type="text" class="validate X">
									<label for="X">X:</label>
								</div>
								<div class="input-field col s4">
									<input placeholder="Ordonné Y" id="Y" name="Y" type="text" class="validate Y">
									<label for="Y">Y:</label>
								</div>
								<div class="input-field col s4">
							...
							<div class="row">
								<div class="col offset-s4">
									<button class="btn waves-effect waves-light" type="submit" name="action" value="remove">Submit
